...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "projects_blocks_content_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "home" (
  	...
  	"pill_one_id" integer NOT NULL,
  	"pill_two_id" integer NOT NULL,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  ALTER TABLE "users_sessions" ADD CONSTRAINT "users_sessions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "projects_blocks_content_block" ADD CONSTRAINT "projects_blocks_content_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "projects_rels" ADD CONSTRAINT "projects_rels_keywords_fk" FOREIGN KEY ("keywords_id") REFERENCES "public"."keywords"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "home" ADD CONSTRAINT "home_pill_one_id_media_id_fk" FOREIGN KEY ("pill_one_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "home" ADD CONSTRAINT "home_pill_two_id_media_id_fk" FOREIGN KEY ("pill_two_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "keywords_title_idx" ON "keywords" USING btree ("title");
  ...
  CREATE INDEX "projects_blocks_content_block_order_idx" ON "projects_blocks_content_block" USING btree ("_order");
  CREATE INDEX "projects_blocks_content_block_parent_id_idx" ON "projects_blocks_content_block" USING btree ("_parent_id");
  CREATE INDEX "projects_blocks_content_block_path_idx" ON "projects_blocks_content_block" USING btree ("_path");
  ...
  CREATE INDEX "projects_rels_keywords_id_idx" ON "projects_rels" USING btree ("keywords_id");
  ...
  CREATE INDEX "home_pill_one_idx" ON "home" USING btree ("pill_one_id");
  CREATE INDEX "home_pill_two_idx" ON "home" USING btree ("pill_two_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "projects_blocks_content_block" CASCADE;
